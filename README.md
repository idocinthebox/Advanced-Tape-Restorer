...
Advanced Tape Restorer is MIT licensed for community use. Commercial/enterprise licensing with priority support will be available for the Pro version (v5.0+).
