...
- [🆓 v4.0 vs 💎 v4.1 - Which Version?](#-v40-vs--v41---which-version)
...
|---------|-------------------------|----------------------------------|
| **💰 Price** | Free forever (MIT) | $45 Early Supporter<br>$150 Standard |
| **📦 Download Size** | 46 MB | 2,944 MB |
| **📥 Download From** | GitHub (fast) | Cloudflare R2 (requires purchase) |
| **🔄 QTGMC Deinterlacing** | ✅ 7 presets | ✅ 7 presets |
| **🎨 Color Correction** | ✅ Full suite | ✅ Full suite |
| **🔇 Denoise/Cleanup** | ✅ BM3D, VHS cleanup | ✅ BM3D, VHS cleanup |
| **📼 Hardware Capture** | ✅ Analog + DV | ✅ Analog + DV |
| **🎯 Multi-GPU Support** | ✅ NVIDIA + AMD + Intel | ✅ NVIDIA + AMD + Intel |
| **💾 Output Formats** | ✅ ProRes, H.264, H.265, etc. | ✅ ProRes, H.264, H.265, etc. |
| **🤖 AI Upscaling** | ❌ Not included | ✅ 8 AI models |
| **🧠 ONNX/NPU Acceleration** | ❌ Not included | ✅ 40x faster, 4K support |
| **👤 Face Restoration** | ❌ Not included | ✅ GFPGAN |
| **🎨 Colorization** | ❌ Not included | ✅ DeOldify |
| **🎞️ Frame Interpolation** | ❌ Not included | ✅ RIFE (2x-4x) |
| **🔧 Video Inpainting** | ❌ Not included | ✅ ProPainter |
| **📞 Support** | Community only | Priority (Standard edition) |
...
**What's Included:**
- ✅ QTGMC deinterlacing (professional quality)
- ✅ BM3D temporal denoising
- ✅ VHS artifact removal (TComb, chroma cleanup)
- ✅ Color correction, sharpening, crop/resize
- ✅ Hardware capture (analog + DV/FireWire)
- ✅ Multi-GPU encoding (NVENC, AMF, Quick Sync)
- ✅ Batch processing, presets, live preview
- ✅ All output codecs (ProRes, H.264/H.265, DNxHD, FFV1)
- ✅ MIT License - fork, modify, use commercially

**What's NOT Included:**
- ❌ No AI upscaling models (RealESRGAN, BasicVSR++, SwinIR)
- ❌ No ONNX/NPU acceleration
- ❌ No face restoration (GFPGAN)
- ❌ No colorization (DeOldify)
- ❌ No frame interpolation (RIFE)
- ❌ No video inpainting (ProPainter)

### 💎 v4.1 Professional Edition (PAID)

**Perfect for:**
- Professionals upscaling SD→HD/4K
...
**What's Included:**
- ✅ **Everything in v4.0** (all MIT components)
- ✅ **8 AI models:**
...
- ✅ **ONNX/NPU acceleration:**
  - 98% model compression (3.82MB → 0.16MB)
...
|----------|-------------|-------------|
| **Basic Restoration** |
| QTGMC Deinterlacing | ✅ 7 presets (Draft→Placebo) | ✅ 7 presets |
| Field Order Detection | ✅ Auto TFF/BFF/Progressive | ✅ Auto |
| Temporal Denoise | ✅ BM3D, FFT3D, KNLMeansCL | ✅ All |
| Spatial Denoise | ✅ RemoveGrain, MCTemporalDenoise | ✅ All |
| VHS Cleanup | ✅ TComb, chroma restoration | ✅ All |
| Color Correction | ✅ Auto levels, saturation, hue | ✅ All |
| Sharpening | ✅ UnsharpMask, LSFmod | ✅ All |
| Crop & Resize | ✅ Aspect ratio correction | ✅ All |
| **AI Upscaling** |
| RealESRGAN 4x | ❌ | ✅ 64MB model |
| BasicVSR++ 2x | ❌ | ✅ 37MB model |
| SwinIR 2-4x | ❌ | ✅ 48MB model |
| ZNEDI3 2x | ❌ | ✅ Fast upscaling |
| **AI Enhancement** |
| RIFE Interpolation | ❌ | ✅ 2x-4x framerate |
| GFPGAN Face Restore | ❌ | ✅ Face enhancement |
| DeOldify Colorization | ❌ | ✅ B&W→Color |
| ProPainter Inpainting | ❌ | ✅ Remove scratches/logos |
| **Performance** |
| ONNX/NPU Acceleration | ❌ | ✅ 40x faster |
| PyTorch JIT Compilation | ❌ | ✅ 20-30% speedup |
| Multi-GPU Distribution | ✅ Heterogeneous support | ✅ Enhanced |
| Threaded I/O | ✅ 2-4x faster batch ops | ✅ Same |
| Checkpoint/Resume | ✅ Long jobs | ✅ Same |
| **Hardware Capture** |
| Analog Devices | ✅ DirectShow detection | ✅ Same |
| DV/FireWire | ✅ Stream copy | ✅ Same |
| Input Selection | ✅ Composite/S-Video/Component | ✅ Same |
| **Output** |
| ProRes | ✅ All variants | ✅ Same |
| H.264/H.265 | ✅ CPU + GPU encoders | ✅ Same |
| DNxHD/DNxHR | ✅ Full support | ✅ Same |
| FFV1 Lossless | ✅ Archival codec | ✅ Same |
| AV1 | ✅ Experimental | ✅ Same |
| **Support** |
| Community Support | ✅ GitHub Issues | ✅ GitHub Issues |
| Priority Email | ❌ | ✅ 48h response (Standard) |
| Documentation | ✅ Full docs | ✅ Full docs |
| **Licensing** |
| License Type | MIT (open source) | Dual (MIT + Proprietary) |
| Commercial Use | ✅ Allowed | ✅ Allowed |
| Modify & Redistribute | ✅ Allowed (v4.0 code) | ⚠️ AI code proprietary |
| Fork & Derivative Works | ✅ Allowed (v4.0 code) | ⚠️ AI code proprietary |

### 💡 Which Version Should I Choose?

**Choose v4.0 (FREE) if you:**
- ✅ Just need deinterlacing and cleanup (no AI)
- ✅ Have slow internet (46MB vs 3GB download)
- ✅ Are digitizing tapes at native resolution (480p/576p)
- ✅ Want to try the software risk-free
- ✅ Need open-source licensing (MIT)
- ✅ Are on a tight budget

**Upgrade to v4.1 (PAID $45/$150) if you:**
- ✅ Need SD→HD or SD→4K upscaling
- ✅ Want AI-powered face restoration (family videos)
- ✅ Have B&W footage that needs colorization
- ✅ Need to remove scratches, logos, or artifacts
- ✅ Want 2x-4x frame rate interpolation
- ✅ Process high-volume professional workflows
- ✅ Have an NPU (Ryzen AI, Intel Meteor Lake) for 40x speedup
- ✅ Need priority support (Standard edition)
