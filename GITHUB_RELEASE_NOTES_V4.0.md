...
- NO AI upscaling models (RealESRGAN, RIFE, BasicVSR++, SwinIR, etc.)
- NO ONNX/NPU acceleration
- NO PyTorch JIT compilation
- NO Face restoration (GFPGAN)
- NO Colorization (DeOldify)
- NO Video inpainting (ProPainter)
...
**File:** Advanced_Tape_Restorer_v4.0_Community_Edition_with_Setup.zip (45.65 MB)
...
**[CLICK HERE TO DOWNLOAD v4.0 (46 MB)](Advanced_Tape_Restorer_v4.0_Community_Edition_with_Setup.zip)**
...
| **QTGMC Deinterlacing** | YES | YES |
| **Denoise/Color** | YES | YES |
| **Hardware Capture** | YES | YES |
| **Multi-GPU** | YES | YES |
| **AI Upscaling** | NO | YES - 8 models |
| **ONNX/NPU** | NO | YES - 40x speedup |
| **Face Restoration** | NO | YES - GFPGAN |
| **Colorization** | NO | YES - DeOldify |
| **Priority Support** | NO | YES (Standard) |
...
**v4.0 excludes:**
- NO PyTorch 2.5 (~2.2GB)
- NO ONNX Runtime (~200MB)
- NO AI model files (~500MB)
- NO TorchScript compiler (~100MB)
